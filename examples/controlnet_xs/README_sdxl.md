# ControlNet-XS training example for Stable Diffusion XL (SDXL)

**Copied from examples/controlnet/README_sdxl.md and not yet fully adjusted to ControlNet-XS**
...
accelerate launch train_controlnetxs_sdxl.py \
